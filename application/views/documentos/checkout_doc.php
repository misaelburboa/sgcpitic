...
<div id="center">
	...
	<?php echo form_open_multipart('checkoutDocument/'.$doc->id_documento); ?>
	<?php
	...
	<div class="form-group">
		...
		<?php echo form_input($metodo_compilacion); ?>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="row">
			...
			<div class="col-xs-3">
				<?php echo form_dropdown($opt_desc_t_ret, $tiempo_retencion_desc, $doc->tiempo_retencion_desc, 'id=tiempo_retencion_desc disabled=\'disabled\''); ?>
			</div>
		</div>
	</div>
	<div class="form-group">
