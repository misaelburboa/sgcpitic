...
<html lang="es">
	<head>
		<title>SGCPitic</title>
		<meta name="viewport" content="width=device-width, initial-scale=1.0" />
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<script type="text/javascript" src=<?php echo base_url()."assets/bootstrap/dist/js/jquery-2.1.4.js"; ?>></script>
		<script type="text/javascript" src=<?php echo base_url()."assets/bootstrap/dist/js/bootstrap.min.js"; ?>></script>
		<script type="text/javascript" src=<?php echo base_url()."assets/bootstrap/dist/js/moment.js"; ?>></script>
		<script type="text/javascript" src=<?php echo base_url()."assets/bootstrap/dist/js/datepicker.min.js"; ?>></script>
		<link rel="stylesheet" type="text/css" href=<?php echo base_url()."assets/bootstrap/dist/css/datepicker.css" ?> />
